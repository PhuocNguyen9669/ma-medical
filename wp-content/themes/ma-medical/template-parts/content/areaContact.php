<?php global $theme_uri; ?> <div id="areaContact">
    <div class="inner">
        ...
        <p class="btnContact"><a href="<?php echo get_permalink(get_page_by_path('contact')); ?>" class="hover">医師への相談・面談予約・<br class="sp">その他お問合せ</a></p>
    </div>
</div>