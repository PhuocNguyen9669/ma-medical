<div class="formSearch">
    <div class="inner">
        <div class="formSearchBox">
            <form role="search" method="GET" id="searchform" action="<?php echo esc_url(home_url('/doctor-list')); ?>">
                <div class="formContent">
                    ...
                    <div class="formField">
                        ...
                        <div class="formInput">
                            <input type="text" id="s" value="<?php get_search_query(); ?>" name="s" class="formInputText" placeholder="疾患名を入力してください">
                        </div>
                    </div>
                    <div class="formField">
